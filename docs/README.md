...
│   └── train.Dockerfile
├── docs/                     # Documentation
│   ├── [mkdocs.yml](http://_vscodecontentref_/2)
│   └── source/
│       └── index.md
...
│   └── test_model.py
├── .gitignore
├── [.pre-commit-config.yaml](http://_vscodecontentref_/3)
├── LICENSE
├── [pyproject.toml](http://_vscodecontentref_/4)            # Python project file
├── [README.md](http://_vscodecontentref_/5)                 # Project README
├── [requirements.txt](http://_vscodecontentref_/6)          # Project requirements
├── [requirements_dev.txt](http://_vscodecontentref_/7)      # Development requirements
└── [tasks.py](http://_vscodecontentref_/8)                  # Project tasks
