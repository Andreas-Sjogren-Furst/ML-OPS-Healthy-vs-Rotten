...
class FruitClassifier(nn.Module):
    ...
    def __init__(self, pretrained_model_name: str = "microsoft/resnet-50", classifier: DictConfig = None):
        super().__init__()
        ...
        self.classifier = nn.Sequential(
            nn.Linear(2048, self.hidden_size), nn.ReLU(), nn.Dropout(self.dropout), nn.Linear(self.hidden_size, 1)
        )
